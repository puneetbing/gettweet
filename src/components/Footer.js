            ...
            <div class="row">
              <div class="col">
                <div class="widget subscribe no-box">
                  ...
                  <p>
                    getTweet.in does not host any pirated or copyright content
                    on its server, open APIs offered by twitter are used to
                    fetch the content of a tweet. Content of each tweet is
                    maintained by twitter.com and this website just fetches the
                    relevant links.
                  </p>
                </div>
              </div>
              <div class="col-md-3">
                <div class="widget no-box">
                  ...
                  <ul class="thumbnail-widget">
                    <li>
                      <div>
                        <a class="gt-footer-link" href="/privacy">
                          Privacy Policy
                        </a>
                      </div>
                    </li>
                    <li>
                      <div>
                        <a class="gt-footer-link" href="/cookie">
                          Cookie Policy
                        </a>
                      </div>
                    </li>
                  ...
                  <ul>
                    ...
                    <li>
                      <a
                        ...
                        href="https://twitter.com/intent/tweet?text=Download any video/gif using https://gettweet.in"
                      >
                        Tweet
                      </a>
                    </li>
