...
const Privacy = (props) => {
  return (
    <div className="gt-policy">
      ...
      <p>
        At getTweet, accessible from https://gettweet.in, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by getTweet
        and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        shared and/or collect in getTweet. This policy is not applicable to any
      ...
      <h4>Log Files</h4>
      <p>
        getTweet follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, getTweet uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        advertising partners of getTweet.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on getTweet, which are sent
      ...
      <p>
        Note that getTweet has no access to or control over these cookies that
        are used by third-party advertisers.
      </p>
      <h4>Third Party Privacy Policies</h4>
      <p>
        getTweet's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        getTweet does not knowingly collect any Personal Identifiable
