...
const Search = () => {
  ...
  const getTweetData = (tweet_data) => {
    try {
      ...
      setTweetData({
        error:
          "[FATAL] Server Error, this incidents has been reported. Apologies for the inconvenience.",
      });
    }
  };
  ...
  const searchTweet = async (status_url) => {
    try {
      ...
      setTweetData({
        error:
          "[FATAL] Server Error, this incident has been reported. Apologies for the inconvenience.",
      });
    }
    showSpinner(false);
  };
    ...
    <>
      ...
      <form id="gt-form" onSubmit={handleOnSubmit}>
        <FormControl fullWidth className={classes.margin} variant="outlined">
          <InputLabel htmlFor="tweet-link" className={labelClassList}>
            {searchLabel}
          </InputLabel>
          <OutlinedInput
            id="tweet-link"
